...
segments_to_proofread = ((m35d.SomaInfo - m35p.AutoProofreadNeuron) & 'n_somas=1').fetch('segment_id')
segments_to_proofread_splits = np.array_split(segments_to_proofread, )
